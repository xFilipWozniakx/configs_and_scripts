...
hl.on("hyprland.shutdown", function()
    os.execute("systemctl --user stop hyprland-session.target && sleep 2")
...
hl.exec_cmd("systemctl --user start anki-cards.service")
hl.window_rule({
...
hl.exec_cmd("systemctl --user enable --now hyprlock.service")
...
--- might cause issues, related to screen sharing
